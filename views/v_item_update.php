...
<table class='table1'>
  ...
  <tr>
    ...
    <td class="itemsBack20"><div class='aLeft'> <span class="itemsBack">
        <input type='text' onclick='dispCal()' class="roundbox" id='saleDate' readonly="true">
      </div>
      </span>
    </div>
    </td>
  ...
  <tr>
    <td colspan="4" class="itemsBack20"><table class='calendar' id='calendar' border=0 cellpadding=0 cellspacing=0>
        ...
        <tr>
          <td colspan=3><table id='dispDays' border=0 cellpadding=4 cellspacing=4>
            </table></td>
        </tr>
      </table></td>
  </tr>
...
<table class='table1'>
  ...
  <tr> <span id='add'>
    <td colspan="2" class='itemsBack'><input type="button" id='addBut' onclick='updateBut()' value="UPDATE ITEM" class="large blue button" /></td>
    </span> </tr>
</table>
<p>&nbsp;</p>
<p>&nbsp;</p>
